...
<head>
    ...
    <style>
        ...
        .notebook {
            ...
            margin: 0; /* 여백 제거 */
            border-radius: 0; /* 전체 화면 느낌을 위해 모서리 곡률 조정 */
            border: none;
        }
...
<body>
    ...
    <script>
        let allBooks = []; 
        let currentPage = 1;
        const itemsPerPage = 8; /* 화면이 넓어졌으므로 페이지당 표시 개수를 약간 늘림 */
        ...
        function updateTitle() {
            document.getElementById('main-title').innerText = `2026 사각사각-${currentPage}`;
        }
